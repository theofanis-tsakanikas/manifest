...
| **Textract** | βαθμίδα 1, για τις έξι τεκμηριωμένες γλώσσες | ✅ **καλωδιωμένο**, ⚠️ ποτέ δεν κλήθηκε |
| **Bedrock Data Automation** | βαθμίδα 2, σειρά ανάγνωσης και πίνακες | ✅ **καλωδιωμένο**, ⚠️ ποτέ δεν κλήθηκε |
