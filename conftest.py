...
`corpus/` and `evals/` are deliberately not inside `src/`: they are not part of the installed
package, because a document generator and a set of labelled scenarios have no business
