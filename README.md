...
| `make gate-proof` | **38 refused, 0 accepted, 0 stale** |
...
does; `gate-proof` breaks 38 controls on purpose and requires the **named** gate to refuse
...
make gate-proof    # break 38 controls on purpose; each must be refused, for the right reason
