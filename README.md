...
| `make gate-proof` | **36 refused, 0 accepted, 0 stale** |
...
does; `gate-proof` breaks 36 controls on purpose and requires the **named** gate to refuse
...
make gate-proof    # break 36 controls on purpose; each must be refused, for the right reason
